...
<div itemscope itemtype="http://schema.org/Event">
	...
	<table style="display:none" class="ignitewoo_event_details event_dates">
...
if ( $primary_sponsors->have_posts() ) while ( $primary_sponsors->have_posts() ) { 
	...
	$primary_sponsors_meta = get_post_custom( $post->ID, true, "orderby=rand" );
	
?>
				<a class="sponsorLogo" itemprop="image" title="<?php the_title() ?>" target="_blank" href="<?php echo $primary_sponsors_meta['_generic_website'][0] ?>">
				<?php the_post_thumbnail( 'thumbnail' ) ?>
				</a>	
<?php } ?>
