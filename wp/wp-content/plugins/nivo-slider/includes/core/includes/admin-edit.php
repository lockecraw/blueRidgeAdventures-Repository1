...
class Dev7_Core_Admin_Edit {
	...
	public function meta_box_usefullinks() {
		...
		echo '<p>' . __( 'Website:', 'dev7core' ) . ' <a href="http://dev7studios.com/plugins/' . $this->labels->slug . '/" target="_blank">' . $this->labels->plugin_name . '</a></p>';
		echo '<p>' . __( 'Created by:', 'dev7core' ) . ' <a href="http://dev7studios.com" target="_blank">Dev7studios</a></p>';
		echo '<p>' . __( 'Support:', 'dev7core' ) . ' <a href="http://support.dev7studios.com/discussions" target="_blank">Support Forums</a></p>';
